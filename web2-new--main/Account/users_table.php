...
<body>
    ...
    <a href="http://localhost:8012/web2-new--main/web2-new--main/Admin.php?chon=createUser" type="button" class="btn btn-primary mx-5">
        Add new user
    </a>
    <!-- Details modal start -->
                ...
                <div class="modal-body">
                    <form action="Account/users_Controller.php">
                        ...
                        <div class="modal-footer">
                            ...
                            <a class="btn btn-danger" onclick="del('users')">Delete</a>
                        </div>
                    </form>
                </div>
