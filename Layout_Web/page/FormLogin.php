                    ...
                    <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
                        <div class="card-body p-4 p-md-5">
                            ...
                            <form action="database/login.php" method="post">
                                <div>
                                    <p class="mb-0 d-flex justify-content-center">Don't have an account? <a href='index.php?number=signup' class="text-black-50 fw-bold">Sign Up</a></p>
                                </div>
                                <div class="d-flex justify-content-center text-center mt-2 pt-1">
                                    <a href="database/connect_facebook.php" class="text-black">
                                    ...
                                    <a href="database/connect_twitter.php" class="text-black">
                                ...
                                <div class="container overflow-hidden">
                                    <div class="row gy-3">
                                        ...
                                        <div class="col-md-6 mb-1 pb-2 w-100">
                                            ...
                                            <p class="mb-3 pb-lg-2 d-flex flex-row-reverse bd-highlight"><a href='index.php?number=reset_passwd' class="text-black-50 fw-bold">Forgot password</a></p>
                                        </div>
                                    </div>
                                    <div class="">
                                        <input class="btn btn-primary btn-lg" type="submit" value="Login" id="check-email" name="btn-log" />
                                    </div>
                                </div>
                            </form>
                        </div>
