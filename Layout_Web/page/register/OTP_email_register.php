                ...
                <div class="col-12 col-lg-9 col-xl-7">
                    <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
                        <div class="card-body p-4 p-md-5">
                            ...
                            <form action="../../database/check_OTP_email.php" method="POST">
                                ...
                                <div class="container overflow-hidden">
                                    ...
                                    <div class="row gy-3">
                                        ...
                                        <div class="col-md-6 mb-0 w-100">
                                            <input type="text" id="email" class="form-control form-control-lg" name="OTP" />
                                ...
                                <div class="d-flex justify-content-evenly text-decoration-none">
                                    <div class="fst-italic">
                                        <div class="d-flex justify-content-start input-group mb-3">
                                            <input class="btn btn-primary btn-lg" type="submit" value="Back" name="back" id="back" />
                                        </div>
                                    </div>
                                    <div class="fst-italic">
                                        <div class="d-flex justify-content-start input-group mb-3">
